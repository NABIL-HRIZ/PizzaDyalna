    ...
    <div class="container-fluid page-body-wrapper">
     ...
     @include('admin.sidebar')
      ...
      <div class="p-4">
        ...
        <h1 style="color: orange;font-size:40px;font-weight:bold;letter-spacing:2px">Add Galery </h1>
      
        <form class="row g-3 mt-4" action="{{url('add_galeries')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-12">
