    ...
    <div class="container-fluid page-body-wrapper">
     ...
     @include('admin.sidebar')
      ...
      <div class="p-4 table-responsive">
        <h1 style="font-size: 40px;font-weight:bold;color:orange;letter-spacing:2p*x">Orders InCompleted</h1>

        <form action="{{url('search_order_incomplet')}}" method="GET" class="mt-4">

            @csrf
            <input type="text" name="search" class="form-control" placeholder="Tap Name food .." style="width: 50%">
            <input type="submit" value="Search" class="btn btn-primary" style="color:#fff;position: relative;top:-42px;right:-460px;background-color:orange">
